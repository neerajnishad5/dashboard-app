  ...
  return (
    <div className="max-w-[78rem] mx-auto">
      <div className="px-2 sm:px-3">
        <div className="overflow-x-auto whitespace-nowrap pb-4 scrollbar-custom scroll-smooth">
          <div className="flex flex-wrap justify-start gap-2 sm:gap-4 sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
